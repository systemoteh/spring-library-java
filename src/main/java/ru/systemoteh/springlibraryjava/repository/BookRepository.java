...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    Page<Book> findByNameContainingIgnoreCaseOrAuthorNameContainingIgnoreCaseOrderByName(String name, String fio, Pageable pageable);

    @Query("select new ru.systemoteh.springlibraryjava.domain.Book(b.id, b.name, b.pageCount, b.isbn, b.genre, b.author, b.publisher, b.publishYear, b.image, b.description, b.viewCount, b.totalRating, b.totalVoteCount, b.avgRating) from Book b")
    ...
    @Query("select new ru.systemoteh.springlibraryjava.domain.Book(b.id, b.image) from Book b")
    List<Book> findTopBooks(Pageable pageable);

    // поиск книг по жанру
    @Query("select new ru.systemoteh.springlibraryjava.domain.Book(b.id, b.name, b.pageCount, b.isbn, b.genre, b.author, b.publisher, b.publishYear, b.image, b.description, b.viewCount, b.totalRating, b.totalVoteCount, b.avgRating) from Book b where b.genre.id=:genreId")
